...
const SignupScreen = () => {
  ...
  const handleSubmit = async () => {
    ...
    let response = await axios.post('/api/users/register', { email: email.value, password: password.value, firstName: firstName.value, lastName: lastName.value, location: location.value}, { proxy:{
    host: 'localhost',
    port: 3000}})
